...
int main(int argc, char **argv)
{
	...
	if (argc != 9)
	{
		fprintf(stderr, "Usage: %s number_of_coders time_to_burnout time_to_compile time_to_debug time_to_refactor number_of_compiles_required dongle_cooldown scheduler\n", argv[0]);
		return (1);
