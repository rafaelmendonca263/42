...
class DroneVisualizer:
    def __init__(self, graph_data):
        ...
        self.width = 1100
        self.height = 750
        self.canvas = tk.Canvas(self.root, width=self.width, height=self.height, bg="#11111b")
        self.canvas.pack()
    ...
    def draw_state(self, current_turn, drones_list):
        ...
        self.canvas.create_text(self.width // 2, 35, text=f"TURNO DE SIMULAÇÃO: {current_turn}", 
