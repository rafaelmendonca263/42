...
if __name__ == "__main__":
    try:
        ...
        common = (
            names["Alice"] & names["Bob"] & names["Charlie"] & names["Dylan"]
        )

        print(f"\nCommon achievements: {common}\n")
        only_Alice = names["Alice"] - (
            names["Bob"] & names["Charlie"] & names["Dylan"]
        )
        only_Bob = names["Bob"] - (
            names["Alice"] & names["Charlie"] & names["Dylan"]
        )
        only_Charlie = names["Charlie"] - (
            names["Bob"] & names["Alice"] & names["Dylan"]
        )
        only_Dylan = names["Dylan"] - (
            names["Bob"] & names["Charlie"] & names["Alice"]
        )
