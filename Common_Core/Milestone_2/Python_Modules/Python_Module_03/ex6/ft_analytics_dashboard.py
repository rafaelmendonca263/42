...
if __name__ == "__main__":
    ...
    players = [
        {"name": "alice", "score": 2300, "achievements": ["first_kill", "level_10"]},
        {"name": "bob", "score": 1800, "achievements": ["first_kill", "level_5"]},
        {"name": "charlie", "score": 2150, "achievements": ["first_kill", "level_10", "boss_slayer"]}
    ]
